    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          initial={false}
        >
          <div className="bg-gradient-to-b from-gray-900 via-purple-900/20 to-gray-900 px-4 py-4 space-y-2 border-t border-white/10">
            {navItems.map((item) => (
              <Link
                key={item.path}
                to={item.path}
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-300 hover:text-white hover:bg-white/5 transition-all group"
            >
              <svg
                className="w-5 h-5 text-gray-300 group-hover:text-purple-400 transition-colors flex-shrink-0"
                fill="currentColor"
                viewBox="0 0 24 24"
                aria-hidden="true"
              >
